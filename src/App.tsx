...
export function App() {
  ...
  const [employeeCommissions, setEmployeeCommissions] = useState<EmployeeCommission[]>(() => loadFromStorage('employeeCommissions', []));
  ...
  return (
    <Routes>
      <Route path="/" element={<AppLayout role={role} setRole={setRole} flash={flash} setFlash={setFlash} />}>
        ...
        <Route path="statements/:statementId" element={<StatementDetailPage role={role} assignedStoreIds={assignedStoreIds} dealers={dealers} statements={statements} transactions={transactions} setTransactions={setTransactions} setStatements={setStatements} setFlash={setFlash} payments={dealerPayments} allocations={dealerPaymentAllocations} setPayments={setDealerPayments} setAllocations={setDealerPaymentAllocations} employees={employees} employeeCommissions={employeeCommissions} setEmployeeCommissions={setEmployeeCommissions} />} />
        ...
        <Route path="assignments" element={role === 'admin' ? <AssignmentsPage /> : <Navigate to="/" replace />} />
